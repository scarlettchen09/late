...
{
	if (!font.loadFromFile("C:\\Users\\dbiso\\Downloads\\y.n.w.u.a.y.ttf"))
	{
		std::cout << "Error opening y.n.w.u.a.y.ttf\n";
		exit(EXIT_FAILURE);
	}
	...
	menu[3].setPosition(sf::Vector2f(width / 1.4, height / (MAX_NUMBER_OF_ITEMS + 1) * 4));
